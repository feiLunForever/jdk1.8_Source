...
# 指定新jar包的存放路径
rt_debug_endorsed_dir=/Library/Java/JavaVirtualMachines/jdk1.8.0_211.jdk/Contents/Home/jre/lib/endorsed
...
if [ ! -d $rt_debug_endorsed_dir ]; then
  ...
  echo "5lovefei" | sudo -S mkdir $rt_debug_endorsed_dir -P now
...
echo "5lovefei" | sudo -S mv rt_debug.jar $rt_debug_endorsed_dir
